...
struct ContentView: View {
    ...
    var body: some View {
        GeometryReader { proxy in
                    ...
                    HStack(alignment: .top, spacing: interItemSpacing) {
                        VStack(spacing: 8) {
                            ...
                            Text("My device is running, but I want to MOD it")
                                .font(.headline)
                            Button {
                                print("[ContentView] Start tapped -> .adbDevices")
                        ...
                        VStack(spacing: 8) {
                            ...
                            Text("My device is bricked, and I want to unbrick it")
                                .font(.headline)
                            Button {
                                print("[ContentView] Go to Fastboot tapped -> .fastboot")
                    ...
                    if !installState.toolsReady {
                        VStack(spacing: 4) {
                            ...
                            Button("Go to Settings") {
                                print("[ContentView] Go to Settings tapped -> .settings")
            ...
            .onAppear { print("[ContentView] onAppear; toolsReady=\(installState.toolsReady)") }
        }
    }
}
